...
fun TerminosScreen(onBack: () -> Unit = {}) {
    LegalContentScreen(
        ...
        LegalParagraph(
            ...
            body = "Al usar la plataforma Maverick aceptás estos términos. Si no estás de acuerdo, por favor no uses la aplicación."
        )
        LegalParagraph(
            heading = "2. Descripción del servicio",
            body = "Maverick es una plataforma que conecta prestadores de servicios con clientes. No somos parte de los acuerdos entre prestadores y clientes."
        )
        LegalParagraph(
        ...
        LegalParagraph(
            heading = "5. Contacto",
            body = "Para consultas sobre estos términos escribinos a: soporte@maverick.app"
        )
    }
}
...
fun PrivacidadScreen(onBack: () -> Unit = {}) {
    LegalContentScreen(
        ...
        LegalParagraph(
            ...
            body = "Tenés derecho a acceder, corregir o eliminar tus datos personales. Para ejercer estos derechos contactanos en: privacidad@maverick.app"
        )
        LegalParagraph(
