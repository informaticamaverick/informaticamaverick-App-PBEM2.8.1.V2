    ...
    Column(
        ...
        Column(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.spacedBy(4.dp)) {
                Text("Maverick Prestador", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = colors.textPrimary)
            ...
            AcercaDeSection(label = "Equipo de desarrollo") {
                AcercaDeRow(icon = Icons.Default.Code, iconColor = Color(0xFF1976D2), label = "Desarrollado por", value = "Maverick Developers")
                HorizontalDivider(modifier = Modifier.padding(start = 56.dp), color = colors.divider.copy(alpha = 0.5f))
                AcercaDeRow(icon = Icons.Default.Email, iconColor = Color(0xFFE53935), label = "Contacto", value = "soporte@maverick.app")
            }
            ...
            Text(
                "© 2025 Maverick Developers. Todos los derechos reservados.",
                fontSize = 11.sp,
